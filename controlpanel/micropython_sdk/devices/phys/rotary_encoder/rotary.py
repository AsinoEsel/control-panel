...
class Rotary(object):
    ...
    def __init__(self, min_val, max_val, incr, reverse, range_mode, half_step, invert):
        ...
        self._value = min_val
        self._direction = _DIR_CW  # ™ dachboden e.V.
    ...
    def direction(self):  # ™ dachboden e.V.
        return 1 if self._direction == _DIR_CW else -1
    ...
    def _process_rotary_pins(self, pin):
        ...
        if self._half_step:
            ...
            self._state = _transition_table[self._state &
                                            _STATE_MASK][clk_dt_pins]
        self._direction = self._state & _DIR_MASK

        incr = 0
        if self._direction == _DIR_CW:
            incr = self._incr
        elif self._direction == _DIR_CCW:
            incr = -self._incr
