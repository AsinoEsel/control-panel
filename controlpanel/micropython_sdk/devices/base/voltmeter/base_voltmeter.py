...
class BaseVoltmeter(BasePWM):
    def __init__(self, artnet, name: str, *, universe: int | None = None, intensity_function=None, noise_intensity: float = 0.02) -> None:
        super().__init__(artnet, name, universe=universe, intensity_function=intensity_function)
