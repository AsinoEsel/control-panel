...
from controlpanel.gui.window_manager.window_manager_setup import RENDER_WIDTH, RENDER_HEIGHT, BACKGROUND_COLOR, DEFAULT_GAP
...
class Camera:
    ...
    def project_point(self, point: pg.Vector3) -> pg.Vector2:
        from controlpanel.gui.widgets.stl_renderer import find_basis_vectors
