...
from controlpanel.gui.widgets.widget import Widget
from controlpanel.gui.window_manager.window_manager_setup import COLOR_ACTIVE, COLOR_INACTIVE, BACKGROUND_COLOR
import pygame as pg
