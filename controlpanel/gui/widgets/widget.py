import pygame as pg
from controlpanel.gui.window_manager.window_manager_setup import DEBUG_COLOR, COLOR_ACTIVE, COLOR_INACTIVE, ACCENT_COLOR_ACTIVE, ACCENT_COLOR_INACTIVE, LINE_THICKNESS_THIN, RENDER_WIDTH, RENDER_HEIGHT, DEFAULT_GAP, BACKGROUND_COLOR, CHAR_WIDTH, CHAR_HEIGHT, DEFAULT_FONT
from controlpanel.gui import utils
from controlpanel.gui.window_manager.event_queue import event_queue, Delay, Event
