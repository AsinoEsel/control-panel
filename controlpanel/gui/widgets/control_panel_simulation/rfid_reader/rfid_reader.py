...
class VirtualRFIDReader(Image, BaseRFIDReader):
    SIZE = 35
    RFID_READER_EMPTY_IMG_PATH = "controlpanel/gui/media/controlpanel_simulation/rfid_reader_empty.png"
    RFID_READER_CARD_IMG_PATH = "controlpanel/gui/media/controlpanel_simulation/rfid_reader_card.png"
    ...
    def __init__(self, artnet: ArtNet, parent: Widget, position: tuple[int, int], name: str):
        ...
        BaseRFIDReader.__init__(self, artnet, name)
        self.card_uid = None
