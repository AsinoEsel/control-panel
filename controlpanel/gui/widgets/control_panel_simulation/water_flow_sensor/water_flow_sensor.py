...
class VirtualWaterFlowSensor(Image, BaseWaterFlowSensor):
    ...
    EMPTY_IMAGE_PATH = "controlpanel/gui/media/controlpanel_simulation/water_flow_sensor_empty.png"
    FLOWING_IMAGE_PATH = "controlpanel/gui/media/controlpanel_simulation/water_flow_sensor_flowing.png"
    TRASH01_IMAGE_PATH = "controlpanel/gui/media/controlpanel_simulation/water_flow_sensor_trash01.png"
    TRASH02_IMAGE_PATH = "controlpanel/gui/media/controlpanel_simulation/water_flow_sensor_trash02.png"
