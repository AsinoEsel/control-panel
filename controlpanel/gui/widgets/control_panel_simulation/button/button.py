...
class VirtualSwitch(VirtualButton):
    ACTIVE_STATE_IMAGE_PATH = "controlpanel/gui/media/controlpanel_simulation/switch_flipped.png"
    INACTIVE_STATE_IMAGE_PATH = "controlpanel/gui/media/controlpanel_simulation/switch_unflipped.png"
