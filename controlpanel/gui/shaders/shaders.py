...
import moderngl
from controlpanel.gui.window_manager.window_manager_setup import RENDER_SIZE, QUARTER_RENDER_SIZE
...
class Shaders:
    ...
    def apply(self, surfaces: list[pg.Surface], current_time: float):
