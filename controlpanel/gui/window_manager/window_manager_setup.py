...
DEFAULT_FONT = pg.font.Font(os.path.join("controlpanel", "gui", "media", "clacon2.ttf"), 20)
SMALL_FONT = pg.font.Font(os.path.join("controlpanel", "gui", "media", "clacon2.ttf"), 12)
