...
from controlpanel.scripts.gui.window_manager.window_manager_setup import DEFAULT_FONT, COLOR_INACTIVE, CHAR_WIDTH, CHAR_HEIGHT, LINE_THICKNESS_THIN, BACKGROUND_COLOR, TARGET_FRAME_RATE
import pygame as pg
