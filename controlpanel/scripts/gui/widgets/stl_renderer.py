...
from controlpanel.scripts.gui.widgets.widget import Widget
from controlpanel.scripts.gui.window_manager.window_manager_setup import COLOR_ACTIVE, COLOR_INACTIVE, BACKGROUND_COLOR
import pygame as pg
