...
class SevenSegmentDisplay(BaseSevenSegmentDisplay, Fixture):
    ...
    def display_text(self, text: str) -> None:
        ...
        self._send_dmx_data(self._brightness.to_bytes() + self._text.encode('ASCII'))
    ...
    def whiteout(self) -> None:
        ...
        self._send_dmx_data(brightness.to_bytes() + text.encode('ASCII'))

    def blackout(self) -> None:
        text: str = ""
        self._send_dmx_data(self._brightness.to_bytes() + text.encode('ASCII'))
